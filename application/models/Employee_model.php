...
class Employee_model extends CI_Model {
	...
	var $table = 'employees';
	var $column_order = array('empId','firstname','lastname', 'id', null); //set column field database for datatable orderable
	...
	private function _get_datatables_query()
	{
		...
		$this->db->from($this->table)->join('shifts', 'employees.shift = shifts.id', 'inner');
